...
const LAVORI_INIZIALI = [
  { codice:"E045", cliente:"Rossi Mario", tel:"347 1234567", tipo:"Privato", tipologia:"Nuovo", indirizzo:"Via Verdi 12, Marcallo", materialePosa:"N. 2 finestre\nN. 3 porte interne", dataRilievo:giorni(-30), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Cantiere nuovo. Problema riscontrato durante la posa dei monoblocchi: attendere risoluzione prima di incassare il saldo.",
    pag:{ modalita:"Acconto", numAcconti:2, accontiRicevuti:1, saldo:false, bloccoSaldo:true },
    diario:[
      { data:giorni(-3), autore:"Davide", testo:"Sollecitato Daniele per la consegna dei serramenti." },
      { data:giorni(-1), autore:"Anna", testo:"Cliente avvisato del problema sui monoblocchi. Ricontattare venerd\u00ec." },
    ],
    consegne:[
      { n:1, descrizione:"Falsi telai / monoblocchi termici", fornitore:"Daniele Serramenti", dataOrdine:giorni(-21), consegna:giorni(-2), stato:"consegnato", dataArrivo:giorni(-2) },
      { n:2, descrizione:"3 porte interne + 2 finestre", fornitore:"Daniele Serramenti", dataOrdine:giorni(-21), consegna:giorni(3), stato:"in_attesa" },
    ],
    pose:[
      { id:1, squadra:"Squadra 3", dataPosa:giorni(-1), voci:[1], notificata:true },
    ],
    consegneCliente:[] },
  { codice:"E041", cliente:"Edil Più Srl", tel:"02 9988776", tipo:"Impresa", tipologia:"Sostituzione", indirizzo:"Via Roma 88, Mesero", materialePosa:"N. 1 porta blindata classe 3", dataRilievo:giorni(-26), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Coordinare con capocantiere.",
    pag:{ modalita:"Riba" },
    consegne:[
      { n:1, descrizione:"Porta blindata classe 3", fornitore:"Daniele Serramenti", dataOrdine:giorni(-18), consegna:giorni(2), stato:"in_attesa" },
    ],
    pose:[
      { id:1, squadra:"Squadra 2", dataPosa:giorni(2), voci:[1], notificata:true },
    ],
    consegneCliente:[
      { n:1, descrizione:"Porta blindata classe 3", data:giorni(1), stato:"in_attesa", insieme:false },
    ] },
  { codice:"E038", cliente:"Bianchi Luca", tel:"339 5556677", tipo:"Privato", tipologia:"Sostituzione", indirizzo:"Via Milano 4, Magenta", materialePosa:"N. 5 porte interne laccate bianche", dataRilievo:giorni(-35), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Saldato. Sollecitare fornitore per ritardo.",
    pag:{ modalita:"Acconto", numAcconti:2, accontiRicevuti:2, saldo:true, bloccoSaldo:false },
    diario:[
      { data:giorni(-2), autore:"Alessandro", testo:"Fornitore Nord conferma consegna entro fine settimana." },
    ],
    consegne:[
      { n:1, descrizione:"5 porte interne laccate bianche", fornitore:"Fornitore Nord", dataOrdine:giorni(-25), consegna:giorni(-2), stato:"in_attesa" },
    ],
    pose:[],
    consegneCliente:[] },
  { codice:"E044", cliente:"Verdi Anna", tel:"348 7778899", tipo:"Privato", tipologia:"Sostituzione", indirizzo:"Via Como 21, Boffalora", materialePosa:"N. 2 finestre\nN. 2 zanzariere", dataRilievo:giorni(-22), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Accesso da cortile interno.",
    pag:{ modalita:"Acconto", numAcconti:1, accontiRicevuti:1, saldo:true, bloccoSaldo:false },
    consegne:[
      { n:1, descrizione:"2 finestre + zanzariere", fornitore:"Daniele Serramenti", dataOrdine:giorni(-15), consegna:giorni(5), stato:"in_attesa" },
    ],
    pose:[
      { id:1, squadra:"Squadra 1", dataPosa:giorni(5), voci:[1], notificata:true },
    ],
    consegneCliente:[
      { n:1, descrizione:"2 finestre + 2 zanzariere", data:giorni(3), stato:"in_attesa", insieme:false },
    ] },
  { codice:"E040", cliente:"Costruzioni Sole", tel:"02 1122334", tipo:"Impresa", tipologia:"Nuovo", indirizzo:"Via Torino 9, Marcallo", materialePosa:"N. 1 portoncino d'ingresso\nN. 4 porte interne", dataRilievo:giorni(-20), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Cantiere nuovo. Prima i falsi telai, poi le porte.",
    pag:{ modalita:"Riba" },
    consegne:[
      { n:1, descrizione:"Falsi telai in legno", fornitore:"Fornitore Sud", dataOrdine:giorni(-12), consegna:giorni(6), stato:"in_attesa" },
      { n:2, descrizione:"Portoncino ingresso + 4 porte", fornitore:"Fornitore Sud", dataOrdine:giorni(-12), consegna:giorni(20), stato:"in_attesa" },
    ],
    pose:[],
    consegneCliente:[
      { n:1, descrizione:"Falsi telai in legno", data:giorni(7), stato:"in_attesa", insieme:false },
      { n:2, descrizione:"Portoncino + 4 porte interne", data:giorni(21), stato:"in_attesa", insieme:true },
    ] },
  { codice:"E043", cliente:"Neri Giuseppe", tel:"333 2223344", tipo:"Privato", tipologia:"Sostituzione", indirizzo:"Via Garibaldi 33, Mesero", materialePosa:"N. 3 cassonetti\nN. 3 tapparelle elettriche", dataRilievo:giorni(-15), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:false }, note:"In attesa acconto per procedere con ordine.",
    pag:{ modalita:"Acconto", numAcconti:2, accontiRicevuti:0, saldo:false, bloccoSaldo:false },
    consegne:[
      { n:1, descrizione:"Cassonetti + tapparelle elettriche", fornitore:"Daniele Serramenti", dataOrdine:giorni(-10), consegna:giorni(12), stato:"in_attesa" },
    ],
    pose:[],
    consegneCliente:[] },
  { codice:"E039", cliente:"Gallo Paola", tel:"347 9990011", tipo:"Privato", tipologia:"Sostituzione", indirizzo:"Via Dante 7, Magenta", materialePosa:"N. 1 porta blindata\nN. 3 porte interne", dataRilievo:giorni(-12), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Primo acconto ricevuto, ordine effettuato. Pagamento in 3 acconti.",
    pag:{ modalita:"Acconto", numAcconti:3, accontiRicevuti:1, saldo:false, bloccoSaldo:false },
    consegne:[
      { n:1, descrizione:"Porta blindata + 3 interne", fornitore:"Fornitore Nord", dataOrdine:giorni(-8), consegna:giorni(18), stato:"in_attesa" },
    ],
    pose:[],
    consegneCliente:[] },
  { codice:"E037", cliente:"Falegnameria Brera", tel:"02 4455667", tipo:"Falegnameria", tipologia:"Sostituzione", indirizzo:"Via Manzoni 2, Marcallo", materialePosa:"— (solo fornitura)", dataRilievo:giorni(-40), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, note:"Solo fornitura: installano in autonomia.", soloFornitura:true,
    pag:{ modalita:"Riba" },
    consegne:[
      { n:1, descrizione:"8 porte grezze da finire", fornitore:"Daniele Serramenti", dataOrdine:giorni(-30), consegna:giorni(4), stato:"in_attesa" },
    ],
    pose:[],
    consegneCliente:[
      { n:1, descrizione:"8 porte grezze", data:giorni(2), stato:"in_attesa", insieme:false },
    ] },
  { codice:"E036", cliente:"Conti Sara", tel:"347 1112233", tipo:"Privato", tipologia:"Sostituzione", indirizzo:"Via Po 5, Magenta", materialePosa:"N. 4 porte interne", dataRilievo:giorni(-70), flags:{ rilievo:true, confermaOrdine:true, ordineMateriali:true }, concluso:true, dataChiusura:giorni(-40), note:"Lavoro completato e consegnato. Cliente soddisfatto.",
    pag:{ modalita:"Acconto", numAcconti:1, accontiRicevuti:1, saldo:true, bloccoSaldo:false },
    consegne:[
      { n:1, descrizione:"4 porte interne laccate", fornitore:"Daniele Serramenti", dataOrdine:giorni(-60), consegna:giorni(-50), stato:"consegnato" },
    ],
    pose:[
      { id:1, squadra:"Squadra 1", dataPosa:giorni(-45), voci:[1], notificata:true },
    ],
    consegneCliente:[
      { n:1, descrizione:"4 porte interne laccate", data:giorni(-47), stato:"consegnato", insieme:false },
    ] },
];
